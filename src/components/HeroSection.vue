<template>
  <section class="hero-shell" ref="heroRef">
    ...
    <div class="hero-top container" ref="heroTopRef">
      <img class="hero-logo" src="/exporigen/exporigen-logo.png" alt="EXPORIGEN logo" />
      ...
      <div class="hero-actions" ref="actionsRef">
        <a href="#registro" class="cta cta-primary">
          <span>Ser Expositor</span>
        ...
        <a href="#sobre" class="cta cta-dark">
      ...
      <p class="hero-subcopy">3 ediciones anuales: Gastronómica, Tsáchila y Agro</p>

      <div class="support-row" aria-label="Supporting brands">
        <span class="support-label">Presentado por</span>
        <div class="support-logos">
          <span>Expositores Locales</span>
          <span>Empresarios SD</span>
          <span>Productores Regionales</span>
        </div>
      </div>
    </div>

    <div class="hero-marquee" aria-label="Feria moments">
      ...
      <div class="marquee-track">
        <img v-for="img in marqueeImages" :key="`a-${img}`" :src="img" alt="Feria expo" loading="lazy" />
        <img v-for="img in marqueeImages" :key="`b-${img}`" :src="img" alt="Feria expo" loading="lazy" />
        <img v-for="img in marqueeImages" :key="`c-${img}`" :src="img" alt="Feria expo" loading="lazy" />
      </div>
...
.hero-radial-a {
  ...
  background: radial-gradient(circle at 44% 42%, rgba(31, 47, 20, 0.14) 0%, rgba(31, 47, 20, 0.09) 34%, rgba(31, 47, 20, 0) 72%);
...
.hero-radial-b {
  ...
  background: radial-gradient(circle at 56% 48%, rgba(181, 98, 26, 0.12) 0%, rgba(181, 98, 26, 0.08) 36%, rgba(181, 98, 26, 0) 74%);
